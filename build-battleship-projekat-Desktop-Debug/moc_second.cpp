...
static const char qt_meta_stringdata_Second[] = {
    "Second\0\0on_Play_clicked()\0on_Close_clicked()\0"
};
...
const QMetaObjectExtraData Second::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Second::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_Second,
      qt_meta_data_Second, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Second::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Second))
